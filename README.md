...
<p align="center">
<em> Customer Churn Dashboard (PowerBI) - See link to Dashboard at the bottom of this page </em> 
  </p>
  
<br>
 
## Introduction 
Dollar Bank Customer Churn Analysis using SQL + Python + PowerBI:  An end-to-end project that involved exploratory analysis with SQL, a deep-dive EDA using Python, and building an interactive dashboard with PowerBI to present meaningful business insights for the bank. 
...
[Link to Python Notebook](https://nbviewer.org/github/abhishek/customer_churn_analysis-SQL-Python-PowerBI/blob/main/Supporting%20Files/notebook.ipynb)
...
[Link to PowerBI Dashboard](https://public.powerbi.com/app/profile/nsikan.udoma/viz/DollarBankCustomerChurnDashboard/CustomerChurnDashboard)
